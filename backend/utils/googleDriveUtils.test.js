import { extractFileId, uploadToGoogleDrive, deleteFromGoogleDrive } from "../utils/googleDriveUtils.js";
...
describe("googleDriveUtils", () => {
  ...
  describe("uploadToGoogleDrive", () => {
    it("should upload a file to Google Drive and return the response data", async () => {
      ...
      const mockResponse = { id: "file123", webViewLink: "https://drive.google.com/file/d/file123/view" };
    ...
    it("should use fs.createReadStream if file buffer is not provided", async () => {
      const mockFile = {
        originalname: "testfile.txt",
        mimetype: "text/plain",
