            ...
            <div className="login-container">
                <div className="login-card">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <p></p>
                        <Link to="/signup" className="btn btn-outline-light w-100 text-decoration-none">
                            Register
                        </Link>
                        <p></p>
                        <Link to="/forgotPassword" className="text-decoration-underline text-light d-block text-center">
                            Forgot Password?
                        </Link>
                    </form>
                </div>
